    ...
    AppScaffold(
        ...
        Column(
            ...
            DashboardLargeButton(
                ...
                backgroundColor = BrownMedium, // CAMBIO: Color marrón medio
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
                DashboardActionCard(
                    ...
                    onClick = { /* Navegar a registro insumos */ }
                )
                DashboardActionCard(
                    modifier = Modifier.weight(1f),
...
fun InfoSedeCard(sedeName: String) {
    Card(
        ...
        colors = CardDefaults.cardColors(containerColor = OliveGreen) // CAMBIO: Color verde oliva
    ) {
        Row(
            modifier = Modifier
                .fillMaxWidth()
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Icon(
                    ...
                    modifier = Modifier
                        .size(48.dp)
                        .background(Peach, RoundedCornerShape(12.dp)) // CAMBIO: Fondo del ícono durazno
                        .padding(8.dp),
...
fun DashboardActionCard(modifier: Modifier = Modifier, title: String, icon: Painter, onClick: () -> Unit) {
    Card(
        ...
        onClick = onClick,
        shape = RoundedCornerShape(16.dp),
        colors = CardDefaults.cardColors(containerColor = BrownMedium) // CAMBIO: Color marrón medio
    ) {
        Column(
            modifier = Modifier
                .fillMaxSize()
...
fun DashboardLargeButton(
    ...
    backgroundColor: Color, // CAMBIO: El color ahora es un parámetro requerido
    onClick: () -> Unit
) {
    Button(
        onClick = onClick,
